...
@section('title')
  <h2 style="margin-top: 2px">相關人員資訊</h2>
@endsection
      ...
      <div class="panel panel-default" > 
        ...
        <div class="panel-body" style="height:100%">
          ...
          <div class="form-group col-md-12 form-horizontal">
            ...
            <label for="server_name" class="col-md-2 control-label" style="text-align:right;">公司名稱:</label>
              <div class="col-md-4">
                <input type="text" name="server_name" class=" col-md-4 form-control" value="{{$data->name}}" readonly>
              </div>
            
            <label for="company_server_type" class="col-md-2 control-label" style="text-align:right;">統一編號:</label>
              <div class="col-md-4">
          ...
          <div class="form-group col-md-12 form-horizontal">
            ...
            <label for="company_business_code" class="col-md-2 control-label" style="text-align:right;">描述:</label>
              <div class="col-md-4">
          ...
          <div class=" form-group col-md-12 form-horizontal" style="border-bottom: 2px solid;border-bottom-color:#d3e0e9;margin-bottom:10px;">
          <label for="display_name" class="col-md-2 control-label" style="text-align:right;">Group</label>
          <label for="display_name" class="col-md-2 col-md-offset-1  control-label" style="text-align:center;">Name</label>
          <label for="display_name" class="col-md-2 col-md-offset-4 control-label" style="text-align:center;">Email</label>
          </div>
          ...
          <div class="form-group col-md-12 form-horizontal">
              ...
              <input type="text" name="company_business_code" class=" col-md-4 form-control ColorOrange"  value="{{$permission->display_name}}" readonly required>
              </div>
          ...
          @endforeach
            ...
            <div class="col-md-12" style="border-top:2px solid; border-top-color:#d3e0e9; padding-top:10px;">
                <script>//彈出對話框確認 
                  function Confirm()
                  {
                    if(confirm("確認刪除此資料？")==true)   
                      window.location="{{URL::route('role_delete', $data->id)}}";
                    else  
                      return false;
                  }   
              ...
              <div class="col-md-2 col-md-offset-3" style="text-align:center;">
                <button type="button" class="btn btn-primary" onclick="location.href='{{route('role_edit', $data->id)}}'">
              ...
              <div class="col-md-2 col-md-offset-3" style="text-align:center;">
                <button type="button" class="btn btn-primary" onclick="location.href='{{route('role_index')}}'">
