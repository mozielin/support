...
@section('title')
  <h2 style="margin-top: 2px">公司類別瀏覽</h2>
@endsection
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group col-md-12 form-horizontal"> 
                ...
                <div class="col-md-4">
                  <input type="text" name="status_id" class="form-control" value="{{$group->id}}" readonly >
                </div>

                 <label for="status_class" class="col-md-3 control-label" style="text-align:right;">Name:</label>
                <div class="col-md-4">
                  <input type="text" name="status_class" class="form-control" value="{{$group->user_group_name}}" readonly >
                </div>  
            </div>
            <div class="form-group col-md-12 form-horizontal">
            ...
            <div class="col-md-4" style="text-align:center;">
                <button type="button" class="btn btn-primary" onclick="location.href='{{route('user_group_edit', $group->id)}}'">
                    <i class="glyphicon glyphicon-pencil"></i> 
                修改
                </button>
            </div>
            <div class="col-md-4" style="text-align:center;">
                <button type="button" class="btn btn-primary" onclick="location.href='{{route('user_group_index')}}'">
