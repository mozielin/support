    ...
    <div class="form-horizontal">
        ...
        <form class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="return Confirm();" action="/contract/upload" >
            ...
            <div class="form-group col-md-12 form-horizontal">
                ...
                <div class="col-md-4">
                    <input type="text" name="contract_title" class=" col-md-4 form-control" style="width:100%;text-align:center" value="{{ old('contract_title') }}" placeholder="請輸入合約標題" required autofocus>
                </div>
        ...
        <div class="form-group col-md-12 form-horizontal">
            ...
            <div class="col-md-4">
                <select class="form-control" style="padding-left:20px;" id="contract_status" name="contract_status" required placeholder="請選擇合約狀態">              
...
<script type="text/javascript">
//若選擇CONTRACT_STATUS則變更其他欄位必塡 
var selectmenu = document.getElementById("contract_status")
selectmenu.onchange=function(){ //run some code when "onchange" event fires
 var chosenoption=this.options[this.selectedIndex] //this refers to "selectmenu"
 console.log(chosenoption.value);

 if (chosenoption.value == "14"){//觸發的ID
    document.getElementById("company_contract_check").required = true;  
    console.log("done");//open target site (based on option's value attr) in new window
 }
 else{//設為必塡的欄位
    document.getElementById("company_contract_check").required = false;  
    console.log("cancel");//open target site (based on option's value attr) in new window'
 }
}
