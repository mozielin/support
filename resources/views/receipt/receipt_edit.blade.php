@extends('layouts.master')
    @section('title')
        <h2 style="margin-top:2px;">發票修改</h2>
    @endsection
@section('contentm')
...
<div class="container" style="width:780px;height:100%;margin-right:218px;">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
                <div class="panel-heading">發票修改</div>
				 <!--區塊標題-->
                <div class="panel-heading" style="text-align:center; height:40px">              
                    ...
                    <label for="nothing" class="col-md-3" style="text-align:right;">Updateby_{{$data->name}}</label>
                </div>
                <div class="panel-body">
                  ...
                  <script>//彈出對話框確認
                    function Confirm()
                    {
                      ...
                      <form class="form-horizontal" method="POST"  onsubmit="return Confirm();" action="{{ route('receipt_update',$data->id) }}">
                        ...
                        {{ csrf_field() }}
                         ...
                         <div class="form-group col-md-12 form-horizontal">
                            ...
                            <label for="rcpdate" class="col-md-2 control-label" style="text-align:right;">發票日期:</label>
                              <div class="col-md-4">
                                <input type="text" id="rcpdate" name="rcpdate" class=" col-md-4 form-control" style="width: 100%;text-align: center;padding-left:0px;" value="{{$data->rcpdate}}" required>           
                              </div>
                        ...
                        <div class="form-group col-md-12 form-horizontal"> 
							...
							<div class="col-md-4">
							  <input type="text" name="rcpnum" class=" col-md-4 form-control" value="{{$data->rcpnum}}"  required>
							</div>  
									
							<label for="price" class="col-md-2 control-label" style="text-align:right;">發票金額:</label>
							<div class="col-md-4">
							  <input type="text" name="price" class=" col-md-4 form-control" value="{{$data->price}}" required>                   
							</div>
						 </div> 
						...
						<div class="form-group col-md-12 form-horizontal" >
							...
							<div class="col-md-10">
							  ...
							  <textarea name="note" style="height:100px;" id="alert_note" class=" col-md-4 form-control noresize " value="{{$data->note}}" >{{$data->note}}</textarea>
                    ...
                    <input type="hidden" name="builder" value="{{Auth::user()->id}}">
                        ...
                        <div class="form-group">
                              <div class="col-md-2 col-md-offset-2" style="text-align: center;">
                                <button type="button" class="btn btn-primary" onclick="location.href='{{route('contract_view',$data->contract_id)}}'">
