...
@section('title')
<h2 style="margin-top: 2px">公司垃圾桶</h2>
@endsection
@section('contentm')
<!--中間選單-->
	...
	<div class="panel panel-default">
		<div class="panel-heading" style="height:62px;text-align:center;"><!--文字置中-->
			...
			@if (Session::has('flash_message'))
				<div class="alert alert-success fade in" style="width:250px;position:absolute;right:350px;top:154px;text-align:center;">
