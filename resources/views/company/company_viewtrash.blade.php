...
@section('title')
  <h2 style="margin-top: 2px">客戶明細(垃圾桶)</h2>
@endsection
    ...
    <div class="panel-heading" >
      <div class="panel panel-default" >
        <div class="panel-heading" style="text-align:center; height:40px">
          ...
          <label for="nothing" class="col-md-3" style="text-align:right;">Deleteby_{{$deleter->name}}</label>     	      
        </div>
          <!--區塊內容-->
          <div class="panel-body" style="height:100%">
            ...
            <div class="form-horizontal" style="height:100%">
              ...
              <div class="form-group col-md-12 form-horizontal" style="height:36px;">
                ...
                <div class="col-md-4">
                    <input type="text" name="deleter" class=" col-md-4 form-control" value="{{$data->area_name}}" readonly >
                  </div> @permission('none')
        ...
        <div class="panel-heading" style="text-align:center; height:40px; padding-top:2px">
          ...
          <div class="container" style="width:100%;height:100%;margin-right:218px;">
            ...
            <script>//彈出對話框確認 
              function Confirm()
              {
                window.alert('會連帶一併復原其餘資料哦(合約、License、聯絡人等等)!');
                if(confirm("請你考慮清楚哦~")==true) 
                  window.alert('按錯...後果自負哦!');
                else  
                  return false;
      
                if(confirm("確認要復原一切公司資料？")==true) 
                  window.location="{{URL::route('company_restore', $data->id)}}";
                else  
                  return false;
              }   
            </script>  
