    ...
    <div class="form-horizontal">
        ...
        <form class="form-horizontal" method="POST" enctype="multipart/form-data" onsubmit="return Confirm();" action="/license/upload" >
            ...
            <div class="form-group col-md-12 form-horizontal">
                ...
                <div class="col-md-4">
                    <input type="text" name="lic_name" class=" col-md-4 form-control" style="width:100%;text-align:center" value="" placeholder="請輸入License Title" required autofocus>
                </div>

                <label for="status_id" class="col-md-2 control-label" style="text-align:right;">Lic狀態:</label>
                <div class="col-md-4">
                    <select class="form-control" style="padding-left:60px;" name="status_id" required placeholder="請選擇License狀態">              
          ...
          <div class="form-group col-md-12 form-horizontal">
            ...
            <label for="start_at" class="col-md-2 control-label" style="text-align:right;">開始日期:</label>
              <div class="col-md-4">
                <input type="text" id="start_at" name="start_at" class=" col-md-4 form-control" style="width: 100%;text-align: center;padding-left:0px;" value="" placeholder="請選擇開始日期" required>               
              </div>
            
            <label for="expir_at" class="col-md-2 control-label" style="text-align:right;">結束日期:</label>
              <div class="col-md-4">
                <input type="text" id="expir_at" name="expir_at" class=" col-md-4 form-control" style="width: 100%;text-align: center;padding-left:0px;" value="" placeholder="請選擇結束日期" required>           
              </div>
        ...
        <div class="col-md-12" style="border-bottom: 2px solid;border-bottom-color:#d3e0e9;margin-bottom:10px;">
          ...
          <div class="form-group{{ $errors->has('tlc_company_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                <input id="tlc_company_name" type="text" class="form-control" name="tlc_company_name" value="{{$company->company_name}}" required readonly>
