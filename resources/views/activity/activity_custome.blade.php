...
<script type="text/javascript">
	$('#activitycustome').ready(function(){
		$value = $('#activitycustome').val();

		$.ajax({
			type : 'get',
			url : '{{ URL::to('/activity/activitycustome') }}',
			data : {'activitycustome' : $value},
			success : function(data){
				console.log(data);
				document.getElementById("activitycustome").value="";
				$('tbody').html(data);
			}
		})
	})					
		...
		<div class="panel-heading" style="height:62px;text-align:center;"><!--文字置中-->
			...
			<div class="right-side" style="width:300px;height:57px;display:flex;justify-content:center;text-align:center;margin-top:3px;">	
					<div class="input-group" style="width:300px;">
						<input id="activitysearch" type="text" class="form-control" name="activitysearch" value="{{ old('activitysearch') }}" placeholder="{{$activitycustome}}" required autofocus style="width:240px;margin-left: 40px;">
						<input type="hidden" id="activitycustome" name="activitycustome" value="{{$activitycustome}}">
