      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group col-md-12 form-horizontal"> 
                ...
                <div class="col-md-4">
                  <input type="text" name="status_class" class="form-control" value="{{$type->company_type_name}}" readonly >
                </div>  
            </div>
            <div class="form-group col-md-12 form-horizontal">
            ...
            <div class="col-md-4" style="text-align:center;">
                <button type="button" class="btn btn-primary" onclick="location.href='{{route('company_type_edit', $type->id)}}'">
                    <i class="glyphicon glyphicon-pencil"></i> 
                修改
                </button>
            </div>
            <div class="col-md-4" style="text-align:center;">
                <button type="button" class="btn btn-primary" onclick="location.href='{{route('company_type_index')}}'">
          ...
          function Confirm()
          {
                  if(confirm("確認刪除此資料？")==true)   
                    window.location="{{URL::route('company_type_delete', $type->id)}}";
                  else  
                    return false;
          }   
          </script>
