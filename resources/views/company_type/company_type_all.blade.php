...
@section('title')
	<div style="width:auto; float:left;" >
		<h2 style="margin-top:2px;">公司類別總覽</h2>
	</div>
	...
	<div class="panel panel-default">
		<div class="panel-heading" style="height:62px;text-align:center;"><!--文字置中-->
			...
			<div class="right-side" style="width:360px;height:57px;float:right;display:flex;justify-content:center;text-align:center;margin-top:3px;">	  	
				<form class="form-horizontal" method="POST" action="{{ route('company_type_store') }}">
					{{ csrf_field() }}
					<div class="input-group{{ $errors->has('company_type_name') ? ' has-error' : '' }}">
						<input id="company_type_name" type="text" class="form-control" name="company_type_name" value="{{ old('company_type_name') }}" placeholder="請輸入類別名稱" required autofocus style="width:250px;margin-left:20px;">
...
<div class="container" style="width:780px;height:100%;margin-right:218px;">
	@foreach($type as $test)
		    <div class="panel panel-default test" style="cursor:pointer;" onclick="location.href='{{route('company_type_view', $test->id)}}'">
