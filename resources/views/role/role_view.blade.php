...
@section('title')
  <h2 style="margin-top: 2px">Role資訊</h2>
@endsection
      ...
      <div class="panel panel-default" > 
        ...
        <div class="panel-body" style="height:100%">
          ...
          <div class="form-group col-md-12 form-horizontal">
            ...
            <label for="server_name" class="col-md-2 control-label" style="text-align:right;">Role名稱:</label>
              <div class="col-md-4">
                <input type="text" name="server_name" class=" col-md-4 form-control" value="{{$data->name}}" readonly>
              </div>
            
            <label for="company_server_type" class="col-md-2 control-label" style="text-align:right;">顯示名稱:</label>
              <div class="col-md-4">
