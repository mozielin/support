...
@section('title')
  <h2 style="margin-top: 2px">修改公司地區</h2>
@endsection
...
<div class="container" style="width:780px;height:100%;margin-right:218px;">
    <div class="panel panel-default">
        <div class="panel-heading">
                <div class="panel-heading" style="text-align:center;">修改地區</div>
                            ...
                            function Confirm()
                            {
                                if(confirm("確認修改此筆資料？")==true)   
                                    ...
                                    return history.back();
                                                      ...
                                                      <!--送出表單前呼叫上面的script-->
                        <form class="form-horizontal" onsubmit="return Confirm();" method="POST" action="{{ route('company_area_update', $area->id) }}" >
                            {{ csrf_field() }}
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input id="area_name" type="text" class="form-control" name="area_name" value="{{$area->area_name}}" required autofocus >
                                    @if ($errors->has('name'))
