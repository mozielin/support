        ...
        <form class="form-horizontal" method="POST"  onsubmit="return Confirm();" action="/applicant/store" >
            ...
            <div class="form-group col-md-12 form-horizontal">
              <label for="company_name" class="col-md-2 control-label" style="text-align:right;">公司名稱:</label>
                    <div class="col-md-4">
                        <input id="company_name" type="text" class="form-control" name="company_name" style="text-align: center;" placeholder="請輸入公司名稱查詢" value="" required autofocus>
              ...
              <div class="col-md-4">
                <input type="text" id="company_applicant_dep" name="company_applicant_dep" class=" col-md-4 form-control" placeholder="請輸入聯絡人所屬部門" style="width: 100%;text-align: center;" value="{{ old('company_applicant_dep') }}" >
            ...
            <div class="form-group col-md-12 form-horizontal">
              ...
              <label for="company_applicant_title" class="col-md-2 control-label" style="text-align:right;">聯絡人級職:</label>
                ...
                <div class="col-md-4">
                  <input type="text" name="company_applicant_title" class=" col-md-4 form-control" style="width:100%;text-align:center" value="{{ old('company_applicant_title') }}" placeholder="請輸入聯絡人級職">
                </div>
          </div>
          ...
          <div class="form-group col-md-12 form-horizontal">
            ...
            <label for="company_applicant_phone" class="col-md-2 control-label" style="text-align:right;">公司電話:</label>
              <div class="col-md-4">
                <input type="text" name="company_applicant_phone" class=" col-md-4 form-control" style="width:100%;text-align:center" value="{{ old('company_applicant_phone')}}" placeholder="請輸入聯絡人電話">               
              </div>
            
            <label for="company_applicant_mobile" class="col-md-2 control-label" style="text-align:right;">聯絡手機:</label>
              <div class="col-md-4">
                <input type="text" name="company_applicant_mobile" class=" col-md-4 form-control" style="width:100%;text-align:center" value="{{ old('company_applicant_mobile') }}" placeholder="請輸入聯絡人手機">            
              </div>
